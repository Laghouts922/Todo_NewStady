		...
		this.state = {
			tasks : [ 
				{	
					id : 1,
					name : 'Задача №1',
					text : 'Сделать домшнее задание по математике к школе'
				},
				{
					id : 2,
					name : 'Задача №2',
					text : 'Для хорошего обмена веществ, нужно пить воду каждый час'
				},
				{
					id : 3,
					name : 'Задача №3',
					text : 'Чтобы Вася, не забыл написать Свете, надо ему об это мнапомнить'
				}
			],
			currentTaskId : null,
			search : '',
